...
//         interpolation:'step-after',            // step-after, cardinal, linear, basis 
      ...
      graficarTiempoRealSensor(configuracionDelGrafico,config.socketHumo);       // <----------------
/******************************** rickshaw - fin ********************************************************/		
	});
});
...
app.controller('controlador', function ($scope, $http) {
	// obtiene los sensores a graficar.
	$http.get('/db/actuadores_EXT_Hab')                   //  <----------------------
		.success(function(datosIniciales){
/******************************** rickshaw - inicio ********************************************************/		
      var configuracionDelGrafico ={
         ancho:900,
...
//         preview: true,                         // 0 = sinPV, 1 = conPV, 2 = sinZoom .
      ...
      graficarTiempoRealActuador(configuracionDelGrafico, config.socketEXT);  // <-------------
/******************************** rickshaw - fin ********************************************************/		
	});
});
